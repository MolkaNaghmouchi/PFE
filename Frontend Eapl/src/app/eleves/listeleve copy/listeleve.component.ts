...
export class  Listenseignanttomponent  implements OnInit {
  ...
  cols = [
    ...
    { field: 'image', header: 'image', class:'ui-p-1' },
    ...
    { field: 'StarterDate', header: 'starterDate', class: 'ui-p-4' },
    // { field: 'cin', header: 'CIN' , class: 'ui-p-5'},
    { field: 'email', header: 'E-mail' , class: 'ui-p-7'},
    { field: 'adresse', header: 'Adresse' , class: 'ui-p-6'},
    { field: 'cin', header: 'Cin' , class: 'ui-p-6'},
    { field: 'Salaire', header: 'salaire' , class: 'ui-p-6'},
    { field: 'age', header: 'age' , class: 'ui-p-6'},
    { field: 'specialité', header: 'specialité' , class: 'ui-p-6'},
    { field: 'Num', header: 'Num' , class: 'ui-p-6'},
    { field: 'role', header: 'role' , class: 'ui-p-6'}
  ];
